"""§12 — painel consolidado.

Implementação completa no caderno `notebooks/WaaS_caderno_v2.ipynb`, seção §12.
...
def gerar_figura():
    ...
    warnings.warn(
        "Implementação de painel ainda no caderno. Migrar para módulo é tarefa "
        "rastreada em docs/DECISIONS.md.",
        FutureWarning,
        stacklevel=2,
    )
    raise NotImplementedError(
        "Implementação atual está em notebooks/WaaS_caderno_v2.ipynb, seção §12."
    )
