...
$\sim 425$ (fator 8$\times$ menor), estável até $\alpha = 0{,}9$. A
dissuasão endógena (R01) compensa a erosão do substrato no nível
agregado. A Proposição~5 é portanto rebaixada para a forma fraca acima;
a forma forte fica registrada como conjectura refutada na configuração
testada.
