...
22 cenários canônicos disponíveis (incluindo os 6 do reframe v2, os 2 do R28 EUA/UE, os 2 do canal puro + erosão Coleman, o R29 da cascata de adesão progressiva e os 2 do R30 da LCMC global):
...
├── cenarios.py            # 22 cenários canônicos + aplicar_cenario
