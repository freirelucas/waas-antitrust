...
26 cenários canônicos disponíveis (incluindo os 6 do reframe v2, os 2 do R28 EUA/UE, os 2 do canal puro + erosão Coleman, os 3 do R29 — cascata arbitrária, calibração Saito 2021 e cruzamento R29 × R26 — e os 4 do R30 — coordenada, descoordenada, assimétrica e com forum shopping):
...
├── cenarios.py            # 26 cenários canônicos + aplicar_cenario
